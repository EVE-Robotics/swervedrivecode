...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("back left",m_swerve.backleft());

    SmartDashboard.putNumber("back right", m_swerve.backright());

    SmartDashboard.putNumber("front right", m_swerve.frontright());

    SmartDashboard.putNumber("front left", m_swerve.backright());
